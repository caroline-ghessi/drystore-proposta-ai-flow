-- Corrigir cálculos de starter e cumeeira na função calcular_por_mapeamento
  ...
  calculos AS (
    SELECT 
      ...
      CASE 
        ...
        -- CORREÇÃO: Cálculo da CUMEEIRA baseado no comprimento (1m por peça)
        WHEN pu.item_codigo = '10472' AND v_comprimento_cumeeira > 0 THEN 
          CEILING(v_comprimento_cumeeira / 1)
        -- Cálculo da CUMEEIRA baseado no espigão (1m por peça)
