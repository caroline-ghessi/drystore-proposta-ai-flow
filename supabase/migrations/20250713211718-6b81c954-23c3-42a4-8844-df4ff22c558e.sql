...
CREATE TABLE public.layout_configuracoes (
    ...
    CONSTRAINT valid_tipo_proposta CHECK (tipo_proposta IN ('energia-solar', 'telhas', 'divisorias', 'pisos', 'forros', 'materiais-construcao', 'tintas-texturas', 'verga-fibra', 'argamassa-silentfloor', 'light-steel-frame', 'impermeabilizacao'))
);
