-- Corrigir produto SUBCOBERTURA TYVEK PROTEC 120
UPDATE produtos_mestre 
SET 
  quantidade_embalagem = 92.9,
  consumo_por_m2 = 0.01076,
  updated_at = NOW()
WHERE codigo = '7427' AND descricao ILIKE '%TYVEK%';

-- Atualizar função calcular_por_mapeamento para incluir lógica customizada do TYVEK
