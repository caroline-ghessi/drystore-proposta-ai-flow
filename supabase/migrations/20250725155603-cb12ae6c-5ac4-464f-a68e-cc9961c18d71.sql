-- Atualizar função calcular_por_mapeamento para incluir lógica de perímetro de encontro com alvenaria
...
BEGIN
  ...
  produtos_unicos AS (
    ...
    AND (
      -- Sempre incluir produtos que não são CAP DE CUMEEIRA, CUMEEIRA VENTILADA, FITA AUTOADESIVA nem BOBINA ALUMINIO
